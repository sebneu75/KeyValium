...
{
    public sealed class TestSharedLocal : IDisposable
    {
        public TestSharedLocal()
        {
            var td = new TestDescription(nameof(TestSharedLocal))
            {
                MinKeySize = 16,
                MaxKeySize = 16,
                MinValueSize = 128,
            ...
            td.Options.SharingMode = SharingModes.SharedLocal;
